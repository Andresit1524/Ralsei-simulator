# Ralsei simulator
Este "juego" es un proyecto de prueba que hice para aprender Godot... y por cariño a Ralsei xd.

La idea es ser un top-down sencillo, con animaciones oficiales (sacadas de un crack de Deltarune xd) de Ralsei, música descargada de Youtube y un diseño de mrd. Cualquier cosa, listo las características del juego disponibles acá en el README.
...
- Un compu (opcional) 👍
- Godot 4.5.1-stable (de preferencia la versión mono)
- Visual Studio Code
